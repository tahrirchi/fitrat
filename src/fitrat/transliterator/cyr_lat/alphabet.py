...
vowels_lower = ["а", "е", "и", "о", "у", "ў", "я", "э", "ё", "ю"]
consonants_lower = [
    "б",
    "д",
    "ф",
...
vowels_upper = ["А", "Е", "И", "О", "У", "Ў", "Я", "Э", "Ё", "Ю"]
consonants_upper = [
    "Б",
    "Д",
    "Ф",
...
cyrillic_uppercase = vowels_upper + consonants_upper
cyrillic_lowercase = vowels_lower + consonants_lower
